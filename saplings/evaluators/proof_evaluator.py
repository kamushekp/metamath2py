...
try:
    ...
    from abstract.Evaluator import Evaluator as BaseEvaluator
...
class ProofEvaluator(BaseEvaluator):
    ...
    Otherwise, return a neutral mid score with a brief reasoning to avoid
    extra LLM calls during heuristic expansions.
    """
