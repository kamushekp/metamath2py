...
class implication_transitivity_FloatingArgs(TypedDict):
    ph: str
    ps: str
    pr: str


class implication_transitivity_EssentialArgs(TypedDict):
    essential_1: str
    essential_2: str


class implication_transitivity:
    """Goal: Prove that if P implies Q, and Q implies R, then P implies R"""
    def __init__(self):
        self.essential_1 = r"""|- ( ph -> ps )"""
        self.essential_2 = r"""|- ( ps -> pr )"""
        self.assertion = r"""|- ( ph -> pr )"""

    def call(self, floatings: implication_transitivity_FloatingArgs, essentials: implication_transitivity_EssentialArgs):
