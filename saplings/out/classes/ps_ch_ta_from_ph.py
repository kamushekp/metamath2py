...
class ps_ch_ta_from_ph_FloatingArgs(TypedDict):
    ph: str
    ps: str
    ch: str
    th: str
...
class ps_ch_ta_from_ph_EssentialArgs(TypedDict):
    essential_1: str
    essential_2: str
    essential_3: str


class ps_ch_ta_from_ph:
    ...
    def call(self, floatings: ps_ch_ta_from_ph_FloatingArgs, essentials: ps_ch_ta_from_ph_EssentialArgs):
