...
class ps_ch_imp_ta_from_ph_and_implications_FloatingArgs(TypedDict):
    ph: str
    ps: str
    ch: str
    th: str
...
class ps_ch_imp_ta_from_ph_and_implications_EssentialArgs(TypedDict):
    essential_1: str
    essential_2: str
    essential_3: str


class ps_ch_imp_ta_from_ph_and_implications:
    """Goal: Prove that if ph is true, and ps implies ch implies th, and ph implies th implies ta, then ps implies ch implies ta."""
    def __init__(self):
    ...
    def call(self, floatings: ps_ch_imp_ta_from_ph_and_implications_FloatingArgs, essentials: ps_ch_imp_ta_from_ph_and_implications_EssentialArgs):
