...
- Интегрировал Saplings с проектом metamath2py и подготовил слой совместимости под OpenAI Agents SDK:
  ...
  - Добавлен экипаж оценщиков (`Proof Evaluation Crew`), который анализирует траекторию, при необходимости использует `verify_proof` и возвращает `TaskResult` со score.
